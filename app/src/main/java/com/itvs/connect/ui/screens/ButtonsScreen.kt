...
fun ButtonsScreen(
    ...
    Column(
        ...
        SectionHeader(
            "Button mapping",
            "Map Voice-button gestures. Rotate ride stats cycles ride time, avg mileage, Maps ETA, and distance left every 10s (press again to stop). Enable Notification access for Maps values."
        )
